                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (session()->get('role') === 'PJ' || session()->get('role') === 'SU') : ?>
                                        <a href="<?= base_url('edit-kelola-data-proyek/' . $item['id']) ?>" class="btn btn-success"><i class="far fa-edit"></i></a>
                                        <a href="<?= base_url('view-document/' . $item['id']) ?>" class="btn btn-primary"><i class="fas fa-file-signature"></i></a>
                                        <form class="btn btn-danger" action="<?php echo base_url('kelola-data-proyek/' . $item['id']); ?>" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus proyek ini?')">
                                            ...
                                            <button type="submit"><i class="fas fa-trash"></i></button><?= csrf_field() ?>
                                        </form>
