        ...
        <form action="<?php echo base_url(); ?>loginProcess" method="POST">
          ...
          <div class="max-w-sm overflow-hidden shadow-lg rounded-lg bg-gray-100 p-6 flex flex-col gap-4 justify-center">
            ...
            <div class="flex flex-col gap-4 justify-center">
              ...
              <input type="number" placeholder="NIP" autofocus name="nip" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
