...
$routes->post('/tambah-dokumen', 'KelolaDataProyekController::postDokumen', ['filter' => 'authGuard']);
$routes->post('/delete-dokumen/(:num)', 'KelolaDataProyekController::deleteDokumen/$1', ['filter' => 'authGuard']);
$routes->get('/export-perusahaan/(:num)', 'KelolaDataProyekController::exportPerusahaan/$1', ['filter' => 'authGuard']);
